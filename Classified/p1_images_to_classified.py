...
subject="biology"
subjectcode="9700"
jsondirectory=f"D:/GitRepos/TeachmeGCSE/json_files/A_bio_p1_db.json"
ChapterNamesJson="D:/GitRepos/TeachmeGCSE/json_files/chapters.json"
imagelocation=f"D:/GitRepos/TeachmeGCSE/Images/subject_questions/a_level/{subjectcode}/p1"
outputdirectory=f"D:/GitRepos/TeachmeGCSE/pdf_path/classified/{subjectcode}"
def MakeClassified(jsondirectory, chapterjson, outputdirectory, imagelocation, subject, subjectcode, hasIndex=True, hasAd=True, hasChapterPages=True, hasMS=True):
    ...
    totaly=0 #records y
    yinpage=0
    VerticalLine=Image.open("D:/GitRepos/TeachmeGCSE/images/misc/verticalline.png").resize((30,2000)) #importing verticalline, and resizing to fit whole page
    FirstPage=True
    ...
    while Flag:
        ...
        if NewChapter and hasChapterPages:    #checks if flag for new chapter is set and the parameter "hasChapterPages" is True to add a Chapter Page
            ...
            while classifiedPDF.will_page_break(imgheight)==False: #makes sure that the new image doesnt overflow, and all are confined on the page
                if Data[i]["Chapter"]!=Data[i-1]["Chapter"] and hasChapterPages:
...
MakeClassified(jsondirectory, ChapterNamesJson, outputdirectory, imagelocation, subject, subjectcode)